...
*/	
	...
	{	
		...
		require( GL_TEMPLATE_DIR_CORE . '/theme-options/option-panel.php' ); // for Custom Menus		
	}
...
<?php
	...
	{	
		wp_enqueue_style('font-awesome-min-css', GL_TEMPLATE_DIR_URI . '/css/font-awesome.min.css');
		wp_enqueue_style('font-awesome-min-css-4.2.0', GL_TEMPLATE_DIR_URI . '/css/font-awesome-4.2.0/css/font-awesome.min.css');
		wp_enqueue_style('bootstrap-min', GL_TEMPLATE_DIR_URI . '/css/bootstrap.min.css');
		...
		wp_enqueue_script('bootstrap-min-js', GL_TEMPLATE_DIR_URI .'/js/menu/bootstrap.min.js');
		wp_enqueue_script('holder-js', GL_TEMPLATE_DIR_URI .'/js/holder.js');
		
		if(is_front_page()) {
		wp_enqueue_script('jquery.themepunch.plugins.min', GL_TEMPLATE_DIR_URI .'/js/jquery.themepunch.plugins.min.js');
